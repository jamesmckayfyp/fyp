  ...
  <div class="line-up">
    <div class="line-up--pitch">
      ...
      <div class="line-up--pitch__position def">
        ...
        <div class="line-up--pitch__position--player">
          <div class="line-up--pitch__position--player__number">
            {{ squadData.teamHome.startXI[0].cb.player.number }}
          </div>
          <div class="line-up--pitch__position--player__name">
            {{ squadData.teamHome.startXI[0].cb.player.name }}
          </div>
        </div>
        <div class="line-up--pitch__position--player">
          <div class="line-up--pitch__position--player__number">
      ...
      <div class="line-up--pitch__position def-mid">
        ...
        <div class="line-up--pitch__position--player">
          <div class="line-up--pitch__position--player__number">
            {{ squadData.teamHome.startXI[0].lcm.player.number }}
          </div>
          <div class="line-up--pitch__position--player__name">
            {{ squadData.teamHome.startXI[0].lcm.player.name }}
          </div>
        </div>
        <div class="line-up--pitch__position--player">
          <div class="line-up--pitch__position--player__number">
            {{ squadData.teamHome.startXI[0].rcm.player.number }}
          </div>
          <div class="line-up--pitch__position--player__name">
            {{ squadData.teamHome.startXI[0].rcm.player.name }}
          </div>
        </div>
        <div class="line-up--pitch__position--player">
          <div class="line-up--pitch__position--player__number">
      ...
      <div class="line-up--pitch__position att-mid">
        <div class="line-up--pitch__position--player">
          <div class="line-up--pitch__position--player__number">
            {{ squadData.teamHome.startXI[0].lam.player.number }}
          </div>
          <div class="line-up--pitch__position--player__name">
            {{ squadData.teamHome.startXI[0].lam.player.name }}
          </div>
        </div>
        <div class="line-up--pitch__position--player">
          <div class="line-up--pitch__position--player__number">
            {{ squadData.teamHome.startXI[0].ram.player.number }}
          </div>
          <div class="line-up--pitch__position--player__name">
            {{ squadData.teamHome.startXI[0].ram.player.name }}
          </div>
        </div>
      </div>
    ...
    <div class="line-up--subs">
      <div class="line-up--subs-left">
      ...
      <div class="line-up--subs-right">
        <div class="line-up--subs-right__head">Manager</div>
